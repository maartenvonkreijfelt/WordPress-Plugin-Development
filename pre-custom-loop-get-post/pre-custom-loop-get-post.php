<?php
/*
Plugin Name: Pre Custom Loops: get_posts()
Description: Demonstrates how to customize the WordPress Loop using get_posts().From the course 'WordPress: Plugin Development' at lynda.com Chapter 04-01
